...
// Filename: simplex krpano strelka no info 2019.ggsk
// Generated Вс 12. май 10:54:07 2019
...
function pano2vrSkin(player,base) {
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hotspot') {
			...
			this.__401.ggParameter={ rx:0,ry:0,a:0,sx:0.4,sy:0.5 };
			this.__401.ggVisible=true;
			...
			this.__div.appendChild(this.__401);
		...
		if (hotspot.skinid=='hotspot1') {
			...
			this.__400.ggParameter={ rx:0,ry:0,a:-60,sx:0.4,sy:0.5 };
			this.__400.ggVisible=true;
			...
			this.__div.appendChild(this.__400);
		...
		} else
		{
			...
			this.__40.ggParameter={ rx:0,ry:0,a:0,sx:0.4,sy:0.5 };
			this.__40.ggVisible=true;
			...
			this.__div.appendChild(this.__40);
		}
	};
