...
// Generated Пн 17. май 18:58:21 2021
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._up__img.setAttribute('src',basePath + 'images-lago-naki/up.svg');
		...
		this._up.onmouseover=function () {
			me._up__img.src=basePath + 'images-lago-naki/up__o.svg';
		}
		this._up.onmouseout=function () {
			me._up__img.src=basePath + 'images-lago-naki/up.svg';
		...
		this._down__img.setAttribute('src',basePath + 'images-lago-naki/down.svg');
		...
		this._down.onmouseover=function () {
			me._down__img.src=basePath + 'images-lago-naki/down__o.svg';
		}
		this._down.onmouseout=function () {
			me._down__img.src=basePath + 'images-lago-naki/down.svg';
		...
		this._left__img.setAttribute('src',basePath + 'images-lago-naki/left.svg');
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._left__img['ondragstart']=function() { return false; };
		this._left.appendChild(this._left__img);
		this._left.onmouseover=function () {
			me._left__img.src=basePath + 'images-lago-naki/left__o.svg';
		}
		this._left.onmouseout=function () {
			me._left__img.src=basePath + 'images-lago-naki/left.svg';
		...
		this._right__img.setAttribute('src',basePath + 'images-lago-naki/right.svg');
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._right__img['ondragstart']=function() { return false; };
		this._right.appendChild(this._right__img);
		this._right.onmouseover=function () {
			me._right__img.src=basePath + 'images-lago-naki/right__o.svg';
		}
		this._right.onmouseout=function () {
			me._right__img.src=basePath + 'images-lago-naki/right.svg';
		...
		this._zoomin__img.setAttribute('src',basePath + 'images-lago-naki/zoomin.svg');
		...
		this._zoomin.onmouseover=function () {
			...
			me._zoomin__img.src=basePath + 'images-lago-naki/zoomin__o.svg';
		}
		this._zoomin.onmouseout=function () {
			me._tt_zoomin.style[domTransition]='none';
			me._tt_zoomin.style.visibility='hidden';
			me._tt_zoomin.ggVisible=false;
			me._zoomin__img.src=basePath + 'images-lago-naki/zoomin.svg';
		...
		this._zoomout__img.setAttribute('src',basePath + 'images-lago-naki/zoomout.svg');
		...
		this._zoomout.onmouseover=function () {
			...
			me._zoomout__img.src=basePath + 'images-lago-naki/zoomout__o.svg';
		}
		this._zoomout.onmouseout=function () {
			me._tt_zoomout.style[domTransition]='none';
			me._tt_zoomout.style.visibility='hidden';
			me._tt_zoomout.ggVisible=false;
			me._zoomout__img.src=basePath + 'images-lago-naki/zoomout.svg';
		...
		this._autorotate__img.setAttribute('src',basePath + 'images-lago-naki/autorotate.svg');
		...
		this._autorotate.onmouseover=function () {
			...
			me._autorotate__img.src=basePath + 'images-lago-naki/autorotate__o.svg';
		}
		this._autorotate.onmouseout=function () {
			me._tt_autorotate.style[domTransition]='none';
			me._tt_autorotate.style.visibility='hidden';
			me._tt_autorotate.ggVisible=false;
			me._autorotate__img.src=basePath + 'images-lago-naki/autorotate.svg';
		}
		...
		this._info__img.setAttribute('src',basePath + 'images-lago-naki/info.svg');
		...
		this._info.onmouseover=function () {
			...
			me._info__img.src=basePath + 'images-lago-naki/info__o.svg';
		}
		this._info.onmouseout=function () {
			me._tt_info.style[domTransition]='none';
			me._tt_info.style.visibility='hidden';
			me._tt_info.ggVisible=false;
			me._info__img.src=basePath + 'images-lago-naki/info.svg';
		}
		...
		this._movemode__img.setAttribute('src',basePath + 'images-lago-naki/movemode.svg');
		...
		this._movemode.onmouseover=function () {
			...
			me._movemode__img.src=basePath + 'images-lago-naki/movemode__o.svg';
		}
		this._movemode.onmouseout=function () {
			me._tt_movemode.style[domTransition]='none';
			me._tt_movemode.style.visibility='hidden';
			me._tt_movemode.ggVisible=false;
			me._movemode__img.src=basePath + 'images-lago-naki/movemode.svg';
		}
		...
		this._fullscreen__img.setAttribute('src',basePath + 'images-lago-naki/fullscreen.svg');
		...
		this._fullscreen.onmouseover=function () {
			...
			me._fullscreen__img.src=basePath + 'images-lago-naki/fullscreen__o.svg';
		}
		this._fullscreen.onmouseout=function () {
			me._tt_fullscreen.style[domTransition]='none';
			me._tt_fullscreen.style.visibility='hidden';
			me._tt_fullscreen.ggVisible=false;
			me._fullscreen__img.src=basePath + 'images-lago-naki/fullscreen.svg';
		}
		...
		this._marker_active__img.setAttribute('src',basePath + 'images-lago-naki/marker_active.svg');
		...
		this._marker_normal__img.setAttribute('src',basePath + 'images-lago-naki/marker_normal.svg');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hs_go') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_go';
			...
			this.__470__img.setAttribute('src',basePath + 'images-lago-naki/hs_470.png');
		...
		if (hotspot.skinid=='hs_clouds') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_clouds';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this.__47__img.setAttribute('src',basePath + 'images-lago-naki/hs_47.png');
		...
		if (hotspot.skinid=='hs_2021_active') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_2021_active';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this.__48=document.createElement('div');
			this.__48.ggId='\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 48';
			this.__48.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__48.ggVisible=true;
			this.__48.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -56px;';
			hs+='top:  -18px;';
			hs+='width: 120px;';
			...
			this.__48__img.setAttribute('src',basePath + 'images-lago-naki/hs_48.png');
			...
			this.__48.appendChild(this.__48__img);
			this.__div.appendChild(this.__48);
		...
		if (hotspot.skinid=='hs_2021_faded') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_2021_faded';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this.__49=document.createElement('div');
			this.__49.ggId='\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 49';
			this.__49.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__49.ggVisible=true;
			this.__49.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -56px;';
			hs+='top:  -19px;';
			hs+='width: 120px;';
			...
			this.__49__img.setAttribute('src',basePath + 'images-lago-naki/hs_49.png');
			...
			this.__49.appendChild(this.__49__img);
			this.__div.appendChild(this.__49);
		...
		if (hotspot.skinid=='hs_2013_active') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_2013_active';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this.__52.ggId='\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 52';
			this.__52.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__52.ggVisible=true;
			this.__52.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -56px;';
			hs+='top:  -19px;';
			hs+='width: 120px;';
			...
			this.__52__img.setAttribute('src',basePath + 'images-lago-naki/hs_52.png');
			...
			this.__52.appendChild(this.__52__img);
			this.__div.appendChild(this.__52);
		} else
		if (hotspot.skinid=='hs_2013_faded') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_2013_faded';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this.__54.ggId='\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 54';
			this.__54.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__54.ggVisible=true;
			this.__54.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -56px;';
			hs+='top:  -19px;';
			hs+='width: 120px;';
			...
			this.__54__img.setAttribute('src',basePath + 'images-lago-naki/hs_54.png');
			...
			this.__54.appendChild(this.__54__img);
		...
		} else
		{
			...
			this.__44=document.createElement('div');
			this.__44.ggId='\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 44';
			this.__44.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__44.ggVisible=true;
			this.__44.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -12px;';
			hs+='top:  -26px;';
			hs+='width: 25px;';
			...
			this.__44__img.setAttribute('src',basePath + 'images-lago-naki/hs_44.png');
			...
			this.__44.appendChild(this.__44__img);
			this.__div.appendChild(this.__44);
