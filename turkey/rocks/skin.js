...
// Filename: simplex_2021_5_turkey-map_no-extra-buttons.ggsk
// Generated Ср 27. апр 16:49:44 2022
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._link.ggUpdateText=function() {
			var hs="\u0421\u0441\u044b\u043b\u043a\u0430 \u043d\u0430 \u044d\u0442\u0443 \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u0443:\n<a href="+me.player.userdata.information+">"+me.player.userdata.information+"<\/a>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.innerHTML=hs;
			}
		...
		this._map_link.innerHTML="\u041a\u0430\u0440\u0442\u0430 \u0441\u043e \u0432\u0441\u0435\u043c\u0438 \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u0430\u043c\u0438: <a href=\"https:\/\/yandex.ru\/maps\/-\/CCUFmUaZ-C\">https:\/\/yandex.ru\/maps\/-\/CCUFmUaZ-C<\/a>";
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hs_copter') {
			this.__div=document.createElement('div');
			this.__div.ggId='hs_copter';
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
